...
import { ApprovalList } from "@/services";
...
const AdminApprovalsList = ({ approvals, selectedId, onSelect }: Props) => {
  ...
  return (
    ...
    >
      <Box sx={{ height: "1030px", overflowY: "auto" ,pr:1.5 }}>
        {approvals?.map((item) => {
          const isSelected = item.id === selectedId;
          const patientName = item.patient?.userName;
          const formName = item.form?.name;
          const priority = item.form?.priority;
