// hooks/useAdminApprovals.ts
import { ApprovalsCounts } from "@/services";
...
export const useAdminApprovals = () => {
  ...
  const params = useMemo(() => ({
    ...
    formPriority: filters.formPriority,
  ...
  const fetcher = useCallback(
    async (p: typeof params, signal: AbortSignal): Promise<ApprovalsListData> => {
      return adminApprovalsService.getApprovals(p, signal);
    },
    [],
  );
