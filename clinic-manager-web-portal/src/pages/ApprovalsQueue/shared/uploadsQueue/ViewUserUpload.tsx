...
import { EmptyStateLoader, CommonIcon } from "@/components/common";
import { useUserUploadView } from "../hooks/uploadHooks/useUserUploadView";
...
const ViewUserUpload = ({ submissionId, onClose }: Props) => {
  const theme = useTheme();
  const isMobile = useMediaQuery(theme.breakpoints.down("md"));
  const { data, loading } = useUserUploadView(submissionId);
  const [hasError, setHasError] = useState(false);

  // Helper to validate URL content
