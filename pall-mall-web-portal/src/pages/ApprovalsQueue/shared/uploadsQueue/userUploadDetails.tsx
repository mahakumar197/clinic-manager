...
import { useUserUploadComments } from "../hooks/uploadHooks/useUserUploadComments";
...
const UserUploadsApprovalDetails = ({
  approvalId,
  onBack,
  onOpenForm,
  onActionSuccess,
  ...
  const { details: approval, loading } = useUploadUserDetails(approvalId);
  ...
  const {
    ...
    reject,
    actionLoading,
  } = useUserUploadComments(approvalId);
    ...
    <Box sx={{ height: "100%", overflowY: "auto" }}>
      ...
      >
        ...
        <Grid container spacing={2} alignItems="flex-start">
          ...
          >
            ...
            {!isMobile && !isBetweenSmAndMd && (
              ...
              >
                {!(isExactly1440 && formOpened) && "View Upload"}
              </CommonButton>
            )}
          </Grid>
        ...
        <Typography variant="h5" sx={{ mb: 3 }}>
          {`Review File Uploads - ${patient?.userName}`}
        </Typography>
...
export default UserUploadsApprovalDetails;
