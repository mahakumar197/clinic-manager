...
import { API_BASE_URL, NOTIFICATION_API_BASE_URL } from "./endpoints";
import { API_TIMEOUT } from "@/constants";

/**
 * Axios instance for Notification service APIs (2093)
 */
const notificationAxiosInstance: AxiosInstance = axios.create({
  ...
  async (error) => {
    ...
    if (
      ...
      try {
        ...
        return notificationAxiosInstance(originalRequest);
      } catch (refreshError) {
